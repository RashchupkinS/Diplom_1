...
class TestBurger:
    ...
    def test_set_buns_set_burgers_bun(self, mock_bun, burger, bun_name, bun_price):
    ...
    def test_get_price_return_burger_price(self, mock_bun, mock_ingredient_1, mock_ingredient_2, burger):
